...
public class PresenterKids {
    ...
    public PresenterKids(PresenterPopular presenterViewMovie, Context c) {
...
//        dialog.show();
        ...
        Call<Movie> call = api.get_kid(c.getString(R.string.THE_MOVIE_DB_API_TOKEN),
